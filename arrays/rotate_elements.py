...
if __name__=="__main__":
    ...
    # O(n) time complexity -> as n increases in size so does the time
    # O(n) space for V1 since you are creating auxillary arrays
    # O(1) space for v2 since you are creating a shallow copy